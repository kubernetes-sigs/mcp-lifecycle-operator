...
func (in *CatalogCounts) DeepCopyInto(out *CatalogCounts) {
	*out = *in
	if in.ToolCount != nil {
		in, out := &in.ToolCount, &out.ToolCount
		*out = new(int32)
		**out = **in
	}
	...
	if in.PromptCount != nil {
		in, out := &in.PromptCount, &out.PromptCount
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatalogCounts.
func (in *CatalogCounts) DeepCopy() *CatalogCounts {
	if in == nil {
		return nil
	}
	out := new(CatalogCounts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MCPServerInfo) DeepCopyInto(out *MCPServerInfo) {
	*out = *in
	...
	if in.CatalogCounts != nil {
		in, out := &in.CatalogCounts, &out.CatalogCounts
		*out = new(CatalogCounts)
		(*in).DeepCopyInto(*out)
	}
}
